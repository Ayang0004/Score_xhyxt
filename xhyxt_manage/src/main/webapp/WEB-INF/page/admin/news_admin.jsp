...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 侧导航管理 <span class="c-gray en">&gt;</span> 动态管理 <span class="c-gray en">&gt;</span> 列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	...
	<span class="l">
	<butten class="btn btn-danger radius" type="butten" <a href="#" onclick="formSubmit('/newsDelete','_self');this.blur();"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除 </a></butten>
	</span> 
	&nbsp;
	<span><a class="btn btn-primary radius" onclick="picture_add('添加动态','/news_admin_add')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加动态</a></span> 
	...
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort">
				...
				<th width="40"><input name="" type="checkbox" value=""></th>
					<th width="30">排序值</th>
					<th width="160">动态标题</th>
					<th width="130">动态名称</th>
					<th width="80">发布日期</th>
					<th width="80">更新日期</th>
					<th width="80">发布状态</th>
					<th width="100">操作</th>
			...
			<tbody>
				...
				<td><input name="id" type="checkbox" value="${n.id}"></td>
					...
					<td>${n.newsTitle} </td>
					<td>${n.newsName} </td>
					<td><fmt:formatDate value="${n.created}" pattern="yyyy-MM-dd" /></td>
					<td><fmt:formatDate value="${n.updated}" pattern="yyyy-MM-dd" /></td>
					...
					<a style="text-decoration:none" class="ml-5" href="/toNewsUpdate?id=${n.id}" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> 
					<a style="text-decoration:none" class="ml-5" href="/newsDelete?id=${n.id}" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
				</tr>
			</tbody>
			</c:forEach>
		</table>
