...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 侧导航管理 <span class="c-gray en">&gt;</span> 课件管理 <span class="c-gray en">&gt;</span> 列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	...
	<span class="l">
	<butten class="btn btn-danger radius" type="butten" <a href="#" onclick="formSubmit('/courseDelete','_self');this.blur();"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除 </a></butten>
	</span> 
	&nbsp;
	<span><a class="btn btn-primary radius" onclick="picture_add('添加内容','/courseware_admin_add')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加内容</a></span>
		...
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			<thead>
				...
				<th width="20"><input name="" type="checkbox" value=""></th>
					<th width="40">排序值</th>
					<th width="140">课件标题</th>
					<th width="140">课件名称</th>
					<th width="60">分类栏目</th>
					<th width="80">发布日期</th>
					<th width="80">更新日期</th>
					<th width="70">发布状态</th>
			...
			<c:forEach items="${coursewareList}" var="c" varStatus="status">
			<tbody>
				<tr class="text-c">
				<td><input name="id" type="checkbox" value="${c.id}"></td>
					<td>${c.id} </td>
					<td>${c.fileTitle} </td>
					<td>${c.fileName} </td>
					<td>${c.fileCategory }</td>
					<td><fmt:formatDate value="${c.created}" pattern="yyyy-MM-dd" /></td>
					<td><fmt:formatDate value="${c.updated}" pattern="yyyy-MM-dd" /></td>
					...
					<a style="text-decoration:none" class="ml-5" href="/courseDelete?id=${c.id}" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
				</tr>
			</tbody>
			</c:forEach>
		</table>
