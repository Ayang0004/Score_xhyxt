...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 侧导航管理 <span class="c-gray en">&gt;</span> 教学方法 <span class="c-gray en">&gt;</span> 列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	...
	<span class="l">
	<butten class="btn btn-danger radius" type="butten" <a href="#" onclick="formSubmit('/teachMethodDelete','_self');this.blur();"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除 </a></butten>
	</span> 
	&nbsp;
	<span><a class="btn btn-primary radius" onclick="picture_add('添加动态','/teach_Method_add')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加动态</a></span> 
	...
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<c:forEach items="${teachMethodList}" var="t" varStatus="status">
			<tbody>
				<tr class="text-c">
				<td><input name="id" type="checkbox" value="${t.id}"></td>
					...
					<a style="text-decoration:none" class="ml-5" href="/teachMethodDelete?id=${t.id}" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
				</tr>
			</tbody>
			</c:forEach>
		</table>
