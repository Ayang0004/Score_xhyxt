...
<link rel="stylesheet" href="../../adminFile/lib/zTree/v3/css/zTreeStyle/zTreeStyle.css" type="text/css">
<!--[if IE 6]>
...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页管理 <span class="c-gray en">&gt;</span> 导航管理 <span class="c-gray en">&gt;</span><a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<table class="table">
	<tr>
		<td width="200" class="va-t"><ul id="treeDemo" class="ztree"></ul></td>
		<td class="va-t"><iframe ID="testIframe" Name="testIframe" FRAMEBORDER=0 SCROLLING=AUTO width=100%  height=390px SRC="/nav_admin_add"></iframe></td>
	</tr>
</table>
<!--_footer 作为公共模版分离出去-->
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="../../adminFile/lib/zTree/v3/js/jquery.ztree.all-3.5.min.js"></script> 
