...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 侧导航管理 <span class="c-gray en">&gt;</span> 视频管理 <span class="c-gray en">&gt;</span> 列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	...
	<span class="l">
	<butten class="btn btn-danger radius" type="butten" <a href="#" onclick="formSubmit('/videoDelete','_self');this.blur();"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除 </a></butten>
	</span> 
	&nbsp;
	<span><a class="btn btn-primary radius" onclick="picture_add('添加内容','')" href="/video_admin_add"><i class="Hui-iconfont">&#xe600;</i> 添加视频</a></span> 
		...
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			<thead>
				...
				<th width="40"><input name="" type="checkbox" value=""></th>
					<th width="30">排序值</th>
					<th width="140">视频标题</th>
					<th width="140">视频名称</th>
					<th width="60">分类栏目</th>
					<th width="80">发布日期</th>
					<th width="80">更新日期</th>
					<th width="80">发布状态</th>
			...
			<c:forEach items="${videoList}" var="v" varStatus="status">
			<tbody>
				<tr class="text-c">
				<td><input name="id" type="checkbox" value="${v.id}"></td>
					...
					<td>${v.fileTitle} </td>
					<td>${v.fileName} </td>
					<td>${v.fileCategory }</td>
					<td><fmt:formatDate value="${v.created}" pattern="yyyy-MM-dd" /></td>
					<td><fmt:formatDate value="${v.updated}" pattern="yyyy-MM-dd" /></td>
					...
					<td class="td-manage"><a style="text-decoration:none" onClick="picture_stop(this,'10001')" href="javascript:;" title="下架"><i class="Hui-iconfont">&#xe6de;</i></a>
					 <a style="text-decoration:none" class="ml-5" href="/videoDelete?id=${v.id}" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
				</tr>
			</tbody>
			</c:forEach>
		</table>
