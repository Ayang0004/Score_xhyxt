				...
				<div id="right_content">
					...
					<div id="tab1" class="tabcontent">
						<div class="archive-list">
							<c:forEach items="${coursewareList }" var="c">
								<ul class="archive-posts group">
									<li><a href="<%=request.getContextPath()%>/downloadCourse?id=${c.id}">${c.fileName}<span
											class="comment_number"><fmt:formatDate
													value="${c.created}" pattern="yyyy-MM-dd" /></span></a></li>
								</ul>
							</c:forEach>
						</div>
						<!--分页组件-->
