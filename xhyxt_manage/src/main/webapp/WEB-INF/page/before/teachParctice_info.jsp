	...
	<!-- 将头部（_head.jsp）包含进来 -->
		...
		<div class="center_content">
				...
				<h2>实践教学</h2>
					<div id="tab1" class="tabcontent">
						<div class="form">
							...
							<h3 class="rc_tit">实践教学</h3>
							<h4 class="rc_time">发布时间：<fmt:formatDate value="${teachParcticeContInfo.created}" pattern="yyyy-MM-dd" /></h4>
						</div>
						<div class="rc_content">
							${teachParcticeContInfo.practiceCont}
						</div>
			...
			<div class="sidebar" id="sidebar">
				...
				<ul>
					<li><a href="/teachTheoryBeforeInfoQuery">理论教学</a></li>
